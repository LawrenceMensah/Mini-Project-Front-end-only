import { cart, removeFromCart, showInCart, updateQuantity } from "../data/carts.js";
...
document.querySelectorAll('.js-save-quantity-link').forEach((link) => {
  ...
  link.addEventListener('click', () => {
    ...
    if (!newQuantity || newQuantity < 1) return; // Prevent NaN or zero
    if(newQuantity > 1000) return; // Prevent greater than 1000
